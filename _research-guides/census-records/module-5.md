---
layout: guide
title: "Module 5 — Municipal & Barrio Enumerations"
description: "Local census substitutes and municipal records that fill gaps in island-wide enumerations — including barrio-level data and local government records."
difficulty: advanced
lang: en
permalink: /research-guides/census-records-module-5/
...
| --- | --- |
| <a href="https://www.icp.pr.gov/archivo-general/" target="_blank" rel="noopener noreferrer"><em>Archivo General de Puerto Rico (AGPR)</em></a> | Municipal fonds: padrones, tax rolls, council records — organized by *municipio* |
| <a href="https://www.familysearch.org/en/wiki/Puerto_Rico_Vital_Records" target="_blank" rel="noopener noreferrer"><em>FamilySearch — Puerto Rico Vital Records Wiki</em></a> | Digitized Puerto Rico collections; draft cards; check catalog by municipality |
| <a href="https://www.ancestry.com/" target="_blank" rel="noopener noreferrer"><em>Ancestry.com</em></a> | WWI and WWII draft registration cards; Puerto Rico databases |
| <a href="https://biblioteca.uprrp.edu/coleccion-puertorriquena/" target="_blank" rel="noopener noreferrer"><em>UPR Río Piedras — Colección Puertorriqueña</em></a> | Historical and genealogical collections |
| <a href="https://pares.culturaydeporte.gob.es/inicio.html" target="_blank" rel="noopener noreferrer"><em>Archivo General de Indias (PARES)</em></a> | Spanish colonial administrative records (pre-1898) |
...
The worksheet for this module provides a pre-formatted planning tool for this process. See also [Module 9 — Handling Parish Access Limitations](/research-guides/census-records-module-9/) for a complementary framework when ecclesiastical records are restricted or missing.
...
*[← Module 4](/research-guides/census-records-module-4/) · [Back to Course Overview](/research-guides/census-records/) · [Module 6 →](/research-guides/census-records-module-6/)*
