---
layout: guide
title: "Module 4 — U.S. Federal Census in Puerto Rico (1910–1950)"
description: "Search and browse U.S. federal census records for Puerto Rico across five available census years: 1910, 1920, 1930, 1940, and 1950."
difficulty: advanced
lang: en
permalink: /research-guides/census-records-module-4/
...
| Resource | Access |
| --- | --- |
| <a href="https://www.familysearch.org/en/wiki/Puerto_Rico_Census" target="_blank" rel="noopener noreferrer"><em>FamilySearch — Puerto Rico Census Wiki</em></a> | Free — indexed 1910–1940; 1950 browse-only |
| <a href="https://www.ancestry.com/" target="_blank" rel="noopener noreferrer"><em>Ancestry.com</em></a> | Subscription — fully indexed, all five years |
| <a href="https://www.archives.gov/research/census" target="_blank" rel="noopener noreferrer"><em>National Archives — Census Research</em></a> | Free — original microfilm guidance |
...
- **Race designation** (see [Module 6](/research-guides/census-records-module-6/) for how this changed across years)
...
1. Search all five census years — do not stop at the first record found
2. Go to the original image and verify every transcription
3. Build a multi-year comparison log with names, ages, and barrio
4. Extend your search to the FAN Club: neighbors, godparents, and associates in surrounding households
5. Document all discrepancies in your research log
6. Correlate with civil registration records (see [Module 8](/research-guides/census-records-module-8/))
7. Record negative searches — if a family is absent from an expected census year, document it

---

## What's Next

[Module 5 — Municipal and Barrio Enumerations](/research-guides/census-records-module-5/) covers local census substitutes, tax lists, voter rolls, and padrones that fill the gaps between federal census years.

---

*[← Module 3](/research-guides/census-records-module-3/) · [Back to Course Overview](/research-guides/census-records/) · [Module 5 →](/research-guides/census-records-module-5/)*

<a href="/assets/pdfs/census-records/Module_4_US_Federal_Census.pdf" target="_blank" rel="noopener noreferrer">⬇ Download this module as PDF</a>
<a href="/assets/pdfs/census-records/WS_03_Federal_Census_Matrix.pdf" target="_blank" rel="noopener noreferrer">⬇ Worksheet: Federal Census Multi-Year Matrix (PDF)</a>
