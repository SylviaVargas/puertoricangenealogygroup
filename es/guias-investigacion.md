...
<button class="quicklink-btn" style="border:none;cursor:pointer;" data-filter="beginner">Nuevo en genealogía</button>
<button class="quicklink-btn" style="border:none;cursor:pointer;" data-filter="records">Encontrar registros</button>
<button class="quicklink-btn" style="border:none;cursor:pointer;" data-filter="dna">Investigación de ADN</button>
</div>
</div>

<div class="resource-filters" id="guide-filters">
<button class="filter-chip active" data-filter="all">Todos</button>
<button class="filter-chip" data-filter="beginner">Principiantes</button>
<button class="filter-chip" data-filter="records">Registros</button>
<button class="filter-chip" data-filter="standards">Estándares y Herramientas</button>
...
<ul>
  <li><a href="/es/guias-investigacion/primeros-pasos/">Introducción a la Genealogía Puertorriqueña</a></li>
  <li><a href="/es/guias-investigacion/primeros-pasos/#video-intro">Video: Primeros Pasos en la Genealogía Puertorriqueña</a></li>
  <li><a href="/es/guias-investigacion/primeros-pasos/#nombres">Entendiendo los Nombres Puertorriqueños</a></li>
  <li><a href="/es/guias-investigacion/primeros-pasos/#registros">Tipos de Registros Clave en Puerto Rico</a></li>
</ul>
</div>
...
<h3>Pruebas de ADN para la Ascendencia Puertorriqueña</h3>
<span class="badge badge-available">✓ Disponible</span>
